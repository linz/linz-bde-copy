This is the README for bde_copy which is a programme that extracts data from LINZ Bulk Data Extracts (BDE) files and copies them to the uncompressed data files. If you would like to know more about the LINZ BDE format and the Landonline BDE see http://www.linz.govt.nz/survey-titles/landonline-data/landonline-bde/index.aspx

This program is released under the terms of the license contained in the LICENSE file.
 
HOW TO BUILD -- Win32 using Visual Studio 2008

1) Download zlib125.zip and zlib125_masm_obj.zip from http://www.winimage.com/zLibDll/index.html
2) Unzip zlib125.zip in root directory
3) Unzip contents of zlib124_masm_obj.zip to zlib-1.2.5\contrib\masmx86
4) Build the VS project file vc\bde_copy.vcproj
